...
# ALLOWED_HOSTS = ['localhost', "online-restaurant-ct16.onrender.com"]
...
# Email configuration - DIFFERENT for Render vs Local
if IS_RENDER:
    # On Render: Don't try to send real emails, disable verification
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    ACCOUNT_EMAIL_VERIFICATION = 'none'  # THIS IS KEY - disables email verification
    print("Running on Render - Email verification DISABLED")
else:
    ...
    EMAIL_HOST_USER = 'shmakeyh12@gmail.com'
    EMAIL_HOST_PASSWORD = 'harhsvkwbynumtru'
    ACCOUNT_EMAIL_VERIFICATION = 'optional'  # Keep for local

# Allauth settings
ACCOUNT_AUTHENTICATION_METHOD = "email"
ACCOUNT_EMAIL_REQUIRED = True
ACCOUNT_UNIQUE_EMAIL = True  # Since we use email authentication

# If you want to keep username authentication instead:
